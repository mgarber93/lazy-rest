...
function Path({type}: { type: string }) {
  ...
  if (type === 'erasure') {
    return <>
      <path d="M21 21L9 21" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
      <path
        ...
        fill="#000000" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
    </>
  }
  if (type === 'edit') {
    return <>
  ...
  if (type === 'save') {
    return <>
      ...
      <path d="M18 21V13.6C18 13.2686 17.7314 13 17.4 13H15" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"
            strokeLinejoin="round"></path>
      <path d="M6 21V17.5" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
      <path d="M12 12H1M1 12L4 9M1 12L4 15" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"
            strokeLinejoin="round"></path>
    </>
  }
  if (type === 'clipboard') {
