  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-x-0 bottom-0 hidden border-b border-black/5 group-last/row:block dark:border-white/5"></div>
        <div
          className="absolute inset-x-0 bottom-2 hidden border-b border-black/5 group-last/row:block dark:border-white/5"></div>
      </div>
      {children}
    </div>
  )
