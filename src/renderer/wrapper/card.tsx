...
export const cardEffect = "rounded bg-neutral-50 dark:bg-neutral-900 dark:shadow drop-shadow shadow-neutral-500 dark:shadow-neutral-950 border-2 border-transparent hover:border-neutral-100 hover:border-opacity-100 dark:hover:border-transparent box-border transition-all duration-1000"
