...
export function KeyValueForm<T extends Record<string, any>>({
  ...
  return (
    <div className={clsx("flex flex-col gap-y-1")}>
      ...
      <div
        className={
          "flex flex-col justify-center w-1/2 ml-auto rounded hover:bg-black/5 border border-transparent hover:border-black/15 dark:hover:bg-white/15 hover:opacity-30 transition pl-2"
        }
