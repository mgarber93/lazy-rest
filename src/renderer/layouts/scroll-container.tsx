...
export function ScrollPageLayout({
  ...
  return (
    <div className={clsx("h-[calc(100vh-46.993px)]")}>
      <Center>
  ...
  return (
    <div className={clsx("h-[calc(100vh-47px)]")}>
      <Center className={""}>
        ...
        <div
          className={clsx("col-span-5 lg:col-span-4 row-span-1 bg-transparent")}
        >
          <UserInputForm
            disabled={convo?.content?.at(-1)?.apiCallPlan ?? false}
          />
        </div>
      </Center>
    </div>
